...
function secondThread()
  ...
  sampAddChatMessage("SampIrcClient3 {FFFFFF}запущен: {EE7878}/crc - {FFFFFF}главное меню", 0x33AA33)
  if AutoConnect then
    connected = true
  end
...
function main()
autoupdate("https://raw.githubusercontent.com/Dekster051/irc_chat/main/-version.json", '['..string.upper(thisScript().name)..']: ', "https://www.blast.hk/threads/133136/")
